...
INSERT INTO `user` (`email`, `hashed_password`, `role`, `nom`, `prenom`)
VALUES
('gladis.valenzuela1008@gmail.com', '$2b$12$9UeOxn4gpITE4itL/z8BjeMw0pjskM7LZI3wFdD4UqIRHd2xuR3Qu', 'admin', 'Valenzuela', 'Gladis'),
('drmamour@seattlegracehospital.com', '$2b$12$tSifCB3prC7Y5c/ibHKvlu7VK0ihJVaOS6IcwAueZuoGzJnZVZlO6', 'standard', 'Sheperd', 'Derek'),
('drglamour@seattlegracehospital.com', '$2b$12$6k7FHCXa3FtaFiHkCCBp5usC0WpsufIRPZQzi7V.AUdRXjb2JeQ/O', 'standard', 'Sloan', 'Mark’),
('test', '$2b$12$CELyA2ckAoLCMHxvtJHygOqH4SCAhiC/Cu6D2u2tKXw7atr5rtAN2', 'standard', 'Data', 'Scientest');